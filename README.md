...
Public hosting for the WristMarks iOS app's **Privacy Policy**, **Support**, and **Terms** pages.
...
- **Terms:** https://tbikov.github.io/wristmarks-legal/terms.html (uses Apple's Standard EULA for V1)
...
| **New third-party network service** (beyond Apple WeatherKit and Apple Maps) | Add it to the "Third-party services" list with a link to its policy. |
